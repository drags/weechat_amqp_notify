...
Generate libnotify (and eventually) Growl notifications from the messages generated by Weechat's [amqp_notify.py](http://www.weechat.org/scripts/source/amqp_notify.rb.html/) script.
